...
export const CREATOR_TEMPLATES: Record<CreatorType, CreatorProgramTemplate> = {
  athlete: {
    creatorType: 'athlete',
    recommendedThemes: ['dark-pro', 'minimalist-white', 'ocean-blue', 'high-contrast', 'monochrome'],
    defaultTheme: 'dark-pro',
    platformPriority: ['instagram', 'tiktok', 'youtube', 'twitter', 'facebook', 'twitch', 'discord', 'spotify'],
  ...
  musician: {
    ...
    recommendedThemes: ['royal-purple', 'neon-cyberpunk', 'pastel-dream', 'dark-pro', 'sunset-orange'],
    defaultTheme: 'royal-purple',
    platformPriority: ['spotify', 'youtube', 'instagram', 'tiktok', 'facebook', 'twitter', 'discord', 'twitch'],
    pointsNameSuggestion: 'Fan Credits',
    pointsNameOptions: ['Fan Credits', 'Superfan Points', 'Music Points', 'Backstage Points', 'Custom'],
    profileDataDefaults: {
      showBio: true,
      showSocialLinks: true,
      showTiers: true,
  ...
  content_creator: {
    ...
    platformPriority: ['youtube', 'tiktok', 'twitch', 'twitter', 'instagram', 'discord', 'facebook', 'spotify'],
    pointsNameSuggestion: 'Community Points',
    pointsNameOptions: ['Community Points', 'Creator Points', 'VIP Points', 'Subscriber Points', 'Custom'],
    profileDataDefaults: {
      showBio: true,
      showSocialLinks: true,
      showTiers: true,
