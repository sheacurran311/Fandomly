        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className={
                statusFilter === 'all' ? 'bg-brand-primary' : 'border-white/20 text-gray-300'
              }
            >
              All
            </Button>
            <Button
              ...
              className={
                statusFilter === 'active' ? 'bg-brand-primary' : 'border-white/20 text-gray-300'
              }
            >
              Active
            </Button>
            <Button
              ...
              className={
                statusFilter === 'draft' ? 'bg-brand-primary' : 'border-white/20 text-gray-300'
              }
            >
              Draft
            </Button>
