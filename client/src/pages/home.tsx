          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center mb-12 sm:mb-16 px-4">
              ...
              <Button 
                ...
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-2 border-brand-secondary text-brand-secondary hover:bg-brand-secondary/20 hover:text-brand-secondary px-8 sm:px-10 lg:px-12 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-lg sm:text-xl transition-all duration-300 h-auto min-h-[48px] sm:min-h-[56px]"
              >
                Explore Programs
              </Button>
            </div>
