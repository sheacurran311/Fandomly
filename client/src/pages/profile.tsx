...
export default function Profile() {
  ...
  const facebookUser = facebookUserInfo
    ? { id: facebookUserInfo.id || '', name: facebookUserInfo.displayName || facebookUserInfo.name || 'Facebook User' }
    : null;
                          ...
                          {programsLoading ? (
                            ...
                            <Alert className="bg-yellow-500/10 border-yellow-500/20">
                              ...
                              <AlertDescription className="text-yellow-400">
                                <p className="mb-3">You haven't created a fan program yet. Create one to start engaging with your audience!</p>
                                <Button 
                                  size="sm"
                            ...
                            <div className="space-y-4">
                              <div className="flex items-center justify-between">
                                <div>
                                  <p className="text-white font-medium">{program.name || 'Your Program'}</p>
