...
import { 
  Store, Palette, Settings, Users, Crown, Zap, 
  Globe, Shield, TrendingUp, Star, Coins, Trophy,
...
const subscriptionTiers = [
  ...
  },
  {
    ...
    features: [
      "Up to 10,000 fan members",
      "25 active campaigns",
      "100 custom rewards",
      "Advanced analytics & insights",
      "Custom domain (yourname.fandomly.com)",
      "Priority support",
      "Campaign automation",
...
const sportCategories = [
  ...
  "Hockey", "Softball", "Cross Country", "Other"
];
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                <input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, nilCompliance: e.target.checked }))}
            ...
            <Card className="bg-white/10 border-white/20 max-w-2xl mx-auto">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  >
                    {formData.name.split(' ').map(word => word[0]).join('').toUpperCase().slice(0, 2) || 'YS'}
                  </div>
                  <div>
                    <h3 className="text-white text-xl font-bold">{formData.name || 'Your Store'}</h3>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-white">{selectedTierData?.limits.maxMembers.toLocaleString()}</div>
                    <div className="text-gray-400 text-sm">Max Members</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-white">{selectedTierData?.limits.maxCampaigns}</div>
                    <div className="text-gray-400 text-sm">Campaigns</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-white">{selectedTierData?.limits.maxRewards}</div>
