      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p>
              By accessing or using Fandomly&apos;s Web3-enabled loyalty rewards platform
          ...
          <section>
            ...
            <p className="mb-4">
              Fandomly provides a loyalty rewards platform that enables creators, athletes, and
              musicians to build lasting relationships with their fans through:
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              To use our Service, you must create an account by connecting a supported Web3 wallet.
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              <li>
                <strong>Creators:</strong> Athletes, musicians, and content creators who establish
                loyalty programs
              </li>
              <li>
                <strong>Fans:</strong> Users who participate in creator loyalty programs and earn
                rewards
              </li>
              <li>
                <strong>Administrators:</strong> Users with elevated permissions to manage tenant
                operations
              </li>
            </ul>
            ...
            <p>
              You agree to provide accurate information, maintain account security, and notify us
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Violate any applicable laws or regulations, including NIL compliance requirements
              </li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4">
              ...
              <li>
                Users are responsible for ensuring compliance with their educational
                institution&apos;s policies
              </li>
            </ul>
            <p>
              Fandomly provides compliance monitoring tools but ultimate responsibility for
              adherence to NIL regulations rests with the individual athlete.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Creators may subscribe to paid plans for enhanced features. Subscription fees are
              processed through Stripe and are non-refundable except as required by law.
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              use, display, and distribute it as necessary to provide the Service.
            </p>

            <h3 className="text-xl font-medium mb-2">7.2 Our Platform</h3>
            <p>
              The Fandomly platform, including all software, text, images, and trademarks, is owned
          ...
          <section>
            ...
            <p className="mb-4">Our Service integrates with third-party platforms including:</p>
            <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <section>
            ...
            <p className="mb-4">
              To the maximum extent permitted by law, Fandomly shall not be liable for any indirect,
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless Fandomly from any claims, losses, damages, or
          ...
          <section>
            ...
            <p>
              Upon termination, your right to access and use the Service will cease immediately, but
              these Terms will remain in effect regarding past use of the Service.
            </p>
          </section>
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <p className="text-sm text-muted-foreground">
              These Terms of Service are effective as of the date last updated above and govern your
              use of the Fandomly platform.
            </p>
          </div>
        </div>
      </div>
